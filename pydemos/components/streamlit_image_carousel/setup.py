...
try:
  ...
  json_dir = os.path.join(parent_dir,
                          "src/streamlit_image_carousel/frontend/package.json")
  package_info = json.load(open(json_dir, "r", encoding="utf-8"))
except Exception as e:
  raise ImportError(
      "An exception has occurred while loading the package.json file:") from e
